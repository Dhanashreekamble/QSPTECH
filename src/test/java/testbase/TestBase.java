...
public class TestBase {
	...
	// ExcelReader("\\src\\test\\resources\\testdata");
	...
	public static void LaunchingBrowser() {
		...
		if (config.getProperty("Browser").equalsIgnoreCase("Chrome")) {
			...
			System.setProperty("webdriver.firefox.driver", "C:\\Users\\JAY GANESH\\Downloads\\IE.exe");
        ...
        test.log(LogStatus.INFO, "Browser has been launched and redirected to url"+config.getProperty("ApplicationUrl"));
}
