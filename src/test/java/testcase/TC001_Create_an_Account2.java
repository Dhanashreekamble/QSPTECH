...
public class TC001_Create_an_Account2 extends TestBase {
	
	@BeforeClass
	public static void isskip(){
		if(!isexecutable("TC001_Create_an_Account2"))	//true		
		throw new SkipException("skipping testcase as its run mode is set to N");
	}
	
	
	@Test(dataProvider="Data_collection")
	public static void TC001_Create_An_Account2(Hashtable<String,String> htdata) throws Exception{
		test = extent.startTest("TC001_Create_An_Account2");
